    ...
    ui(new Ui::MainWindow)
{
    ...
    QPushButton* pb1 = new QPushButton("Добавить кафе");
    QPushButton* pb2 = new QPushButton("Удалить кафе");
...
void MainWindow::AddRow()
{
    ...
    {
        Cafe* std = new Cafe(addDialog->id(),addDialog->name(),addDialog->address(),addDialog->typeKitchen(),addDialog->timeWork(),this);
        myModel->AddCafe(std);
    }
